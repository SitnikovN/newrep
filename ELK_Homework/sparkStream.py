...
from pyspark.sql.types import StructType, StructField, DoubleType, StringType,IntegerType,BooleanType,DateType
...
df_stream = data\
        .writeStream\
        .format('es')\
        .option("checkpointLocation", 'files/') \
        .outputMode('append') \
        .option('es.resource','test13')\
